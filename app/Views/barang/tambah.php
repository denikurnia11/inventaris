      ...
      <div class="panel-body">
        <form method="POST" action="<?= base_url('admin/barang/save') ?>" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="jml_barang" class="form-control" placeholder="Jumlah" min="0">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="harga" id="harga" class="form-control" placeholder="Harga" min="0">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="date" id="tgl_perolehan" name="tgl_perolehan" class="form-control" placeholder="Tanggal Perolehan">
            </div>
          </div>
