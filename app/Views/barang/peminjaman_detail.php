    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 text-left" for="id_barang">ID Barang</label>
            <div class="col-sm-10">
              <input type="text" id="id_barang" name="id_barang" value="<?= $barang['id_barang'] ?>" readonly class="form-control">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="nama_barang" name="nama_barang" value="<?= $barang['nama_barang'] ?>" readonly class="form-control">
            </div>
          </div>

          <div class="form-group">
            <label class="col-sm-2 text-left" for="jml_barang">Jumlah Barang</label>
            <div class="col-sm-10">
              <input type="text" id="jml_barang" name="jml_barang" value="<?= $barang['jml_barang'] ?>" readonly class="form-control">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="jml_barang" name="jml_barang" value="<?= $peminjaman['jml_barang'] ?>" readonly class="form-control">
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function konfirmasi() {
    ...
    window.location.replace(`<?= base_url('admin/peminjaman/barang/changeStatus') ?>/${id_peminjaman}?status=${status}`)
  }
</script>
