      ...
      <div class="panel-body">
        <form method="POST" action="<?= base_url('admin/barang/update/' . $barang['id_barang']) ?>" enctype="multipart/form-data" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="nama_barang" name="nama_barang" value="<?= $barang['nama_barang'] ?>" class="form-control <?= ($validasi->hasError('nama_barang')) ? 'is-invalid' : '' ?>" placeholder="Nama Barang">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="id_kategori" value="<?= $barang['id_kategori'] ?>" id="kategori" class="form-control <?= ($validasi->hasError('id_kategori')) ? 'is-invalid' : '' ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="jml_barang" value="<?= $barang['jml_barang'] ?>" class="form-control <?= ($validasi->hasError('jml_barang')) ? 'is-invalid' : '' ?>" placeholder="Jumlah" min="0">
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="harga" value="<?= $barang['harga'] ?>" id="harga" class="form-control <?= ($validasi->hasError('harga')) ? 'is-invalid' : '' ?>" placeholder="Harga" min="0">
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="date" id="tgl_perolehan" value="<?= $barang['tgl_perolehan'] ?>" name="tgl_perolehan" class="form-control <?= ($validasi->hasError('tgl_perolehan')) ? 'is-invalid' : '' ?>" placeholder="Tanggal Perolehan">
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="deskripsi" id="deskripsi" class="form-control <?= ($validasi->hasError('deskripsi')) ? 'is-invalid' : '' ?>" placeholder="Deskripsi"><?= $barang['deskripsi'] ?></textarea>
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <br>
              <img src="<?= base_url('/files/barang/' . $barang['foto']) ?>" width="100px" height="100px">
            </div>
