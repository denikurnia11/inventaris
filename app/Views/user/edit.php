      ...
      <div class="panel-body">
        <form method="POST" action="<?= base_url('admin/user/save') ?>" enctype="multipart/form-data" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="nama_lengkap" name="nama_lengkap" value="<?= $user['nama_lengkap'] ?>" class="form-control <?= ($validasi->hasError('nama_lengkap')) ? 'is-invalid' : '' ?>" placeholder="Nama Lengkap">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="email" id="email" name="email" value="<?= $user['email'] ?>" class="form-control <?= ($validasi->hasError('email')) ? 'is-invalid' : '' ?>" placeholder="Email">
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="username" value="<?= $user['username'] ?>" name="username" class="form-control <?= ($validasi->hasError('username')) ? 'is-invalid' : '' ?>" placeholder="Username">
              <div class="invalid-feedback">
