  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="POST" action="<?= base_url('admin/user/update') ?>" enctype="multipart/form-data" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 text-left" for="nama_lengkap">Nama Lengkap</label>
            <div class="col-sm-10">
              <input value="<?= $user['nama_lengkap'] ?>" type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input value="<?= $user['email'] ?>" type="email" id="email" name="email" class="form-control" placeholder="Email">
            </div>
          </div>
